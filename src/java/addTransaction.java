...
public class addTransaction extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      t.setNumber(request.getParameter("number"));
      t.setAmount(request.getParameter("amount"));
      t.setIfsc(request.getParameter("IFSC"));
      t.setAcc(request.getParameter("acc"));
      
      response.getWriter().write(String.valueOf(t.insert()));
    }
